...
public class Game1 {
    ...
    public static class SceneEvent {
        ...
        public static SceneEvent parse(String line) throws Exception {
            ...
            evt.musNum = Integer.parseInt( columns[1] );
            evt.pakFile = columns[2];
            evt.pakNum = Integer.parseInt( columns[3] );
            evt.placeName = columns[4];
            evt.caracters = Arrays.asList( columns[5].split("\\,") );
            evt.text = columns[6];
            String[] caps = columns[7].split("\\,");
            for(String cap : caps) {
        ...
        public String toCode() {
            ...
            spaces+"musNum[ "+(newId+TP_ARRY_OFFSET)+" ] := "+ musNum +"; \r\n"+
        ...
        public static String toStruct() {
            ...
            return spaces+"placeNam : array[1..nbScene] of string[32]; \r\n"+
                   spaces+"musNum   : array[1..nbScene] of integer; \r\n"+
    ...
    public void process(String dataFileName) throws Exception {
        ...
        writeToFile(fout, "{ AutoGenerated include file }");
        writeToFile(fout, "");
