...
public class Z80 implements  Z80debug
{
 ...
 static /*final*/ boolean DEBUG = false; //fixme
 ...
 */
 ...
 public final void interrupt(int type, boolean irq) {
	 if (type == INTERRUPT_TYPE_NMI) {
		 nmi();
	 } else if (type == INTERRUPT_TYPE_IRQ) { // type ==IRQ
		 irq();
	 }
 }
 ...
 */
 ...
 // Xts
 public final void setPC(int addr) {
    PC = addr;
 }
 ...
 */
 public final void reset() {
 	...
 	PC=0;A=0;F=0;B=0;C=0;D=0;E=0;H=0;L=0;I=0;R=0;IX=0xffff;IY=0xffff;
 	cycle=0;
...
/** $ED prefix opcodes */
 private final void prefix_ED() {
	 ...
	 switch (instruction & 0xff) {
	  case 0x40:	cycle-=12; B=in(C,B); break;			// IN B,(C)		ok
	  case 0x41:	cycle-=12; out(C,B); break; 			// OUT (C),B	ok
	  ...
	  case 0x48:	cycle-=12; C=in(C,B); break;			// IN C,(C)		ok
	  case 0x49:	cycle-=12; out(C,D); break; 			// OUT (C),D	ok
	  case 0x4a:	cycle-=15; adcHL(BC()); break; 			// ADC HL,BC
	  case 0x4b:	cycle-=20; B=peekb(peekw(PC)+1); C=peekb(peekw(PC)); PC+=2; break; // LD BC,(nn)
	  ...
	  case 0x50:	cycle-=12; D=in(C,B); break;			// IN D,(C)		ok
	  case 0x51:	cycle-=12; out(C,D); break; 			// OUT (C),E
	  ...
	  case 0x58:	cycle-=12; E=in(C,B); break;			// IN E,(C)		ok
	  case 0x59:	cycle-=12; out(C,E); break; 			// OUT (C),E
	  case 0x5a:	cycle-=15; adcHL(DE()); break; 			// ADC HL,DE
	  case 0x5B:	cycle-=20; D=peekb(peekw(PC)+1); E=peekb(peekw(PC)); PC+=2; break; // LD DE,(nn)
	  ...
	  case 0x60:	cycle-=12; H=in(C,B); break;			// IN H,(C)		ok
	  case 0x61:	cycle-=12; out(C,H); break; 			// OUT (C),H
	  ...
	  case 0x68:	cycle-=12; L=in(C,B); break;			// IN L,(C)		ok
	  case 0x69:	cycle-=12; out(C,L); break; 			// OUT (C),L
	  case 0x6a:	cycle-=15; adcHL(HL()); break; 			// ADC HL,HL
	  case 0x6B:	cycle-=20; H=peekb(peekw(PC)+1); L=peekb(peekw(PC)); PC+=2; break; // LD HL,(nn)
	  ...
	  case 0x78:	cycle-=12; A=in(C,B); break;			// IN A,(C)
	  case 0x79:	cycle-=11; out(C,A,B); break; 			// OUT (C),A
	  ...
	  case 0xa0:	cycle-=21; 								// LDI
					tmp1=DE(); tmp2=HL(); tmp3=BC(); pokeb(tmp1,peekb(tmp2++)); tmp1=(tmp1+1)&0xffff; tmp3=(tmp3-1)&0xffff;
...
/** $CB prefix opcodes */
 private final void prefix_BC() {
	 ...
	 switch (instruction&0xff) {
		 ...
		 case 0x06: cycle-=15; pokeb(HL(),rlc(HLi())); break;
		 ...
		 case 0x0e: cycle-=15; pokeb(HL(),rrc(HLi())); break;
		 ...
		 case 0x16:	cycle-=15; pokeb((HL()), rl(HLi())); break;
		 ...
		 case 0x1E:	cycle-=15; pokeb((HL()), rr(HLi())); break;
		 ...
		 case 0x26:	cycle-=12; pokeb((HL()), sla(HLi())); break;
		 ...
		 case 0x2e:	cycle-=12; pokeb((HL()), sra(HLi())); break;
		 ...
		 case 0x36:	cycle-=12; pokeb((HL()), sll(HLi())); break;
		 ...
		 case 0x3e: cycle-=12; pokeb((HL()), srl(HLi())); break;
		 ...
		 case 0x86: cycle-=12; pokeb(HL(),res(0,HLi())); break;
		 ...
		 case 0x8e: cycle-=12; pokeb(HL(),res(1,HLi())); break;
		 ...
		 case 0x96: cycle-=12; pokeb(HL(),res(2,HLi())); break;
		 ...
		 case 0x9e: cycle-=12; pokeb(HL(),res(3,HLi())); break;
		 ...
		 case 0xa6: cycle-=12; pokeb(HL(),res(4,HLi())); break;
		 ...
		 case 0xae: cycle-=12; pokeb(HL(),res(5,HLi())); break;
		 ...
		 case 0xb6: cycle-=12; pokeb(HL(),res(6,HLi())); break;
		 ...
		 case 0xbe: cycle-=12; pokeb(HL(),res(7,HLi())); break;
		 ...
		 case 0xc6: cycle-=12; pokeb(HL(),set(0,HLi())); break;
		 ...
		 case 0xce: cycle-=12; pokeb(HL(),set(1,HLi())); break;
		 ...
		 case 0xd6: cycle-=12; pokeb(HL(),set(2,HLi())); break;
		 ...
		 case 0xde: cycle-=12; pokeb(HL(),set(3,HLi())); break;
		 ...
		 case 0xe6: cycle-=12; pokeb(HL(),set(4,HLi())); break;
		 ...
		 case 0xee: cycle-=12; pokeb(HL(),set(5,HLi())); break;
		 ...
		 case 0xf6: cycle-=12; pokeb(HL(),set(6,HLi())); break;
		 ...
		 case 0xfe: cycle-=12; pokeb(HL(),set(7,HLi())); break;
...
/** $DD and $FD prefix opcodes (index instructions) */
 private final int execXY(int XY) {
	...
	switch (instruction&0xff) {
		...
		case 0x26 : cycle-=11; XY=(XY&0x00ff)|(peekb(PC++)<<8); break;		// LD HXY,n		ok
		case 0x27 :
		...
		case 0x2e : cycle-=11; XY=(XY&0xff00)|peekb(PC++); break;
		case 0x2f :
		case 0x30 :
		case 0x31 :
		case 0x32 :
		case 0x33 : error(instruction, PPC); break; // Not implemented
		case 0x34 :	cycle-=15; pokeb(IXYd,inc8(peekb(IXYd))); PC++; break; // INC (XY+d)	ok
		case 0x35 :	cycle-=15; pokeb(IXYd,dec8(peekb(IXYd))); PC++; break; // DEC (XY+d)	ok
		case 0x36 :	cycle-=19; pokeb(IXYd,peekb(PC+1)); PC+=2; break; 	// LD (XY+d),n
		case 0x37 :
		...
		case 0x46 :	cycle-=11; B=peekb(IXYd); PC++; break; 						// LD B,(XY+d)	ok
		case 0x47 :
		case 0x48 :
		case 0x49 :
		case 0x4a :
		...
		case 0x4e :	cycle-=11; C=peekb(IXYd); PC++; break; 					// LD C,(XY+d)	ok
		case 0x4f :
		case 0x50 :
		case 0x51 :
		case 0x52 :
		...
		case 0x56 :	cycle-=11; D=peekb(IXYd); PC++; break; 					// LD D,(XY+d)	ok
		case 0x57 :
		case 0x58 :
		case 0x59 :
		case 0x5a :
		...
		case 0x5e :	cycle-=11; E=peekb(IXYd); PC++; break; 					// LD E,(XY+d)	ok
		...
		case 0x66 :	cycle-=11; H=peekb(IXYd); PC++; break; 					// LD H,(XY+d)	ok
		...
		case 0x6e :	cycle-=11; L=peekb(IXYd); PC++; break; 					// LD L,(XY+d)	ok
		case 0x6f : cycle-=11; XY = (XY&0xff00) | A; break;
		case 0x70 :	cycle-=11; pokeb(IXYd,B); PC++; break; 					// LD (XY+d),B	ok
		case 0x71 :	cycle-=11; pokeb(IXYd,C); PC++; break; 					// LD (XY+d),C	ok
		case 0x72 :	cycle-=11; pokeb(IXYd,D); PC++; break; 					// LD (XY+d),D	ok
		case 0x73 :	cycle-=11; pokeb(IXYd,E); PC++; break; 					// LD (XY+d),E	ok
		case 0x74 :	cycle-=11; pokeb(IXYd,H); PC++; break; 					// LD (XY+d),H	ok
		case 0x75 :	cycle-=11; pokeb(IXYd,L); PC++; break; 					// LD (XY+d),L	ok
		case 0x77 :	cycle-=11; pokeb(IXYd,A); PC++; break; 					// LD (XY+d),A	ok
		case 0x78 :
		case 0x79 :
		case 0x7a :
		...
		case 0x7e :	cycle-=11; A=peekb(IXYd); PC++; break; 					// LD A,(XY+d)	ok
		case 0x7f :
		case 0x80 :
		case 0x81 :
		case 0x82 :
		...
		case 0x86 :	cycle-=11; A=addA_8(peekb(IXYd),A); PC++; break; 			// ADD A,(XY+d)	ok
		case 0x87 :
		case 0x88 :
		case 0x89 :
		case 0x8a :
		...
		case 0x8e :	cycle-= 11; A=adcA_8(peekb(IXYd),A); PC++; break; 		// ADC A,(XY+d)	ok
		case 0x8f :
		case 0x90 :
		case 0x91 :
		case 0x92 :
		...
		case 0x96 :	cycle-= 11; A=subA_8(peekb(IXYd),A); PC++; break; 		// SUB A,(XY+d)	ok
		case 0x97 :
		case 0x98 :
		case 0x99 :
		case 0x9a :
		...
		case 0x9e :	cycle-= 11; A=sbcA_8(peekb(IXYd),A); PC++; break; 		// SBC A,(XY+d)	ok
		case 0x9f :
		case 0xa0 :
		case 0xa1 :
		case 0xa2 :
		...
		case 0xa6 :	cycle-=11; A=andA(peekb(IXYd),A); PC++; break; 			// AND (XY+d)	ok
		case 0xa7 :
		case 0xa8 :
		case 0xa9 :
		case 0xaa :
		...
		case 0xae :	cycle-=11; A=xorA(peekb(IXYd),A); PC++; break; 			// XOR (XY+d)	ok
		case 0xaf :
		case 0xb0 :
		case 0xb1 :
		case 0xb2 :
		...
		case 0xb6 :	cycle-=11; A=orA(peekb(IXYd),A); PC++; break; 			// OR (XY+d)	ok
		case 0xb7 :
		case 0xb8 :
		case 0xb9 :
		case 0xba :
		...
		case 0xbe :	cycle-= 11; cpA_8(peekb(IXYd),A); PC++; break; 			// CP (XY+d)	ok
		case 0xcb :	//---------------------------Second table-----------------------------
					IXYd = XY + sign(peekb(PC++));
					instruction = (instruction << 8) + peekb(PC++);
					switch (instruction&0xff) {
						case 0x06: cycle-=15; pokeb(IXYd, rlc(peekb(IXYd))); break; // RLC (IXYd)	ok
						case 0x0E: cycle-=15; pokeb(IXYd, rrc(peekb(IXYd))); break; // RRC (IXYd)	ok
						case 0x16: cycle-=12; pokeb(IXYd,  rl(peekb(IXYd))); break; // RL (IXYd)		ok
						case 0x1E: cycle-=12; pokeb(IXYd,  rr(peekb(IXYd))); break; // RR (IXYd)		ok
						case 0x26: cycle-=12; pokeb(IXYd, sla(peekb(IXYd))); break; // SLA (IXYd)	ok
						case 0x2e: cycle-=12; pokeb(IXYd, sra(peekb(IXYd))); break; // SRA (IXYd)	ok
						case 0x36: cycle-=12; pokeb(IXYd, sll(peekb(IXYd))); break; // SLL (IXYd)	ok
						case 0x3e: cycle-=12; pokeb(IXYd, srl(peekb(IXYd))); break; // SRL (IXYd)	ok
						case 0x40:
						case 0x41:
						case 0x42:
						case 0x43:
						...
						case 0x45:
						case 0x46:
						case 0x47: cycle-=12; bit(0,peekb(IXYd)); break;
						case 0x48:
						case 0x49:
						case 0x4a:
						case 0x4b:
						...
						case 0x4d:
						case 0x4e:
						case 0x4f: cycle-=12; bit(1,peekb(IXYd)); break;
						case 0x50:
						case 0x51:
						case 0x52:
						case 0x53:
						...
						case 0x55:
						case 0x56:
						case 0x57: cycle-=12; bit(2,peekb(IXYd)); break;
						case 0x58:
						case 0x59:
						case 0x5a:
						case 0x5b:
						...
						case 0x5d:
						case 0x5e:
						case 0x5f: cycle-=12; bit(3,peekb(IXYd)); break;
						case 0x60:
						case 0x61:
						case 0x62:
						case 0x63:
						...
						case 0x65:
						case 0x66:
						case 0x67: cycle-=12; bit(4,peekb(IXYd)); break;
						case 0x68:
						case 0x69:
						case 0x6a:
						case 0x6b:
						...
						case 0x6d:
						case 0x6e:
						case 0x6f: cycle-=12; bit(5,peekb(IXYd)); break;
						case 0x70:
						case 0x71:
						case 0x72:
						case 0x73:
						...
						case 0x75:
						case 0x76:
						case 0x77: cycle-=12; bit(6,peekb(IXYd)); break;
						case 0x78:
						case 0x79:
						case 0x7a:
						case 0x7b:
						...
						case 0x7d:
						case 0x7e:
						case 0x7f: cycle-=12; bit(7,peekb(IXYd)); break;
						case 0x86: cycle-=12; pokeb(IXYd,res(0,peekb(IXYd))); break;
						case 0x8e: cycle-=12; pokeb(IXYd,res(1,peekb(IXYd))); break;
						case 0x96: cycle-=12; pokeb(IXYd,res(2,peekb(IXYd))); break;
						case 0x9e: cycle-=12; pokeb(IXYd,res(3,peekb(IXYd))); break;
						case 0xa6: cycle-=12; pokeb(IXYd,res(4,peekb(IXYd))); break;
						case 0xae: cycle-=12; pokeb(IXYd,res(5,peekb(IXYd))); break;
						case 0xb6: cycle-=12; pokeb(IXYd,res(6,peekb(IXYd))); break;
						case 0xbe: cycle-=12; pokeb(IXYd,res(7,peekb(IXYd))); break;
						case 0xc6: cycle-=12; pokeb(IXYd,set(0,peekb(IXYd))); break;
						case 0xce: cycle-=12; pokeb(IXYd,set(1,peekb(IXYd))); break;
						case 0xd6: cycle-=12; pokeb(IXYd,set(2,peekb(IXYd))); break;
						case 0xde: cycle-=12; pokeb(IXYd,set(3,peekb(IXYd))); break;
						case 0xe6: cycle-=12; pokeb(IXYd,set(4,peekb(IXYd))); break;
						case 0xee: cycle-=12; pokeb(IXYd,set(5,peekb(IXYd))); break;
						//case 0xf4: cycle-=12; pokeb(IXYd,set(6,peekb(IXYd))); // undocumented
						//						H=peekb(IXYd); break;
						case 0xf6: cycle-=12; pokeb(IXYd,set(6,peekb(IXYd))); break;
						case 0xfe: cycle-=12; pokeb(IXYd,set(7,peekb(IXYd))); break;
 ...
 */
 ...
 public int peekb(int add)
 {
     ...
     return mem._RamRead(add & 0xffff) & 0xff;
 }

 public void pokeb(int add,int value)
 {
     // memory[add & 0xffff] = value & 0xff;
     mem._RamWrite( add & 0xffff, (char)(value & 0xff) );
 ...
 */
 ...
 private void debug(int instruction, int PPC, int A, int F, int B, int C, int D, int E,
	...
	if (debugEnabled) {
		...
		String dataLog=Integer.toHexString(PPC)+" : "
			+ Integer.toHexString(peekb(PPC))+","
			+ Integer.toHexString(peekb(PPC+1))+","
			+ Integer.toHexString(peekb(PPC+2))+","
			+ Integer.toHexString(peekb(PPC+3))+"    \t";
		if (instruction < 256) {
			dataLog=dataLog+opc1[instruction];
		} else if (opcgroup == (237<<8)) {
			dataLog=dataLog+opc3[(instruction&0xff)];
		} else if (opcgroup == (203<<8)) {
			dataLog=dataLog+opc2[(instruction&0xff)];
		}
		dataLog=dataLog +"   AF:" + Integer.toHexString(AF())
						+  " BC:" + Integer.toHexString(BC())
						+  " DE:" + Integer.toHexString(DE())
						+  " HL:" + Integer.toHexString(HL())
						+  " SP:" + Integer.toHexString(SP)
						+  " IX:" + Integer.toHexString(IX)
						+  " IY:" + Integer.toHexString(IY)
						+  " I:"  + Integer.toHexString(I)
						+  " Cycles:" + Integer.toString(cycles);
