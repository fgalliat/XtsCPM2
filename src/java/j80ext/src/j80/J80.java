 ...
 *
 */
public class J80 extends j80.cpu.Z80
{
	...
	protected VDU getVDU() { return vdu; }
	protected CRT getCRT() { return crt; }
		...
		while (st.hasMoreElements())
		{
			...
			for (int i = 0 ; i < ms.length ; i++)
			{
				...
				if (m.getName().equals(method))
				{
					...
					if (classes[0].equals(java.lang.Integer.TYPE))
					{
	...
	private void configDiskImage(String name) throws Exception
	{
		...
		configDisk(unit,new j80.disk.ImageDisk(file,sector));
	}
	...
	private void configDiskDir(String name) throws Exception
	{
		...
		configDisk(unit,new j80.disk.DirectoryDisk(file));
	}
	...
	protected void config(String name) throws Exception
	{
		BufferedReader rd = new BufferedReader(new InputStreamReader(new FileInputStream(name)));
		String s;
