 ...
 *
 */
public class Screen extends JComponent implements Peripheral,InPort,VDU,Polling,ActionListener,KeyListener,FocusListener,Spectrum
{
	...
	public void connectCPU(J80 cpu) throws Exception
	{
		...
		frame= new JFrame(j80.J80.version);
		...
		box.add(buttonResume,g1);g1.gridy++;
		box.add(buttonPause,g1);g1.gridy++;
		box.add(buttonSnapshot,g1);g1.gridy++;
		box.add(buttonExit,g1);g1.gridy++;
